...
class HeaderFooterPageEvent extends PdfPageEventHelper {
    ...
    public void onStartPage(PdfWriter writer, Document document){
    	  final String IMAGE2 = "C:\\Users\\Lenovo\\eclipse-workspace\\ResumeBuilder\\sjdc.jpg";
    	  PdfContentByte canvas = writer.getDirectContentUnder();
    	  Image image2;
		try {
			image2 = Image.getInstance(IMAGE2);
			image2.setAbsolutePosition(0,0);
	          image2.scaleToFit(682,842);
...
public class MAIN{
    ...
    MAIN(Map detailsFromRB) {
        details = detailsFromRB;
    }
    public void createResume() throws IOException {
    	
    	ByteArrayOutputStream bos = new ByteArrayOutputStream();
    	String path2=(String) details.get("profile");
        Document resume = new Document(PageSize.A4);
        final String IMAGE =path2;
      
        final String DEST = "resume.pdf";
        
        try {
        	PdfWriter writer =PdfWriter.getInstance(resume, new FileOutputStream("resume.pdf"));
            ...
            image.setAbsolutePosition(460,660);
            image.scaleToFit(100, 110);
